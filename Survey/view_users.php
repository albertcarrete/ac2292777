...
if (isset($_GET['p']) && is_numeric($_GET['p'])) { // Already been determined.
	...
	$q = "SELECT COUNT(user_id) FROM `$tablename`.`ac2292777_survey_users`";
...
// Define the query:
$q = "SELECT last_name, first_name, DATE_FORMAT(registration_date, '%M %d, %Y') AS dr, user_id FROM `$tablename`.`ac2292777_survey_users` ORDER BY $order_by LIMIT $start, $display";		
