...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (empty($errors)) { // If everything's OK.
		...
		<div class="results">
			...
			<a class="result-button" href="./view_users.php">Edit Users</a>
...
?>
			...
			<form action="edit_user.php?id=<?php echo $id; ?>" method="post" autocomplete="off">
				<input type="text" name="username" size="20" maxlength="15" placeholder="Username" autocomplete="off" value="<?php echo $_POST['username'] ?>"/>

				<input type="text" name="email" size="20" maxlength="30" placeholder="Email" autocomplete="off" value="<?php echo $_POST['email'] ?>"/>
				<input type="text" name="first_name" size="20" maxlength="15" placeholder="First Name" autocomplete="off" value="<?php echo $_POST['first_name'] ?>" />
				<input type="text" name="last_name" size="20" maxlength="15" placeholder="Last Name" autocomplete="off" value="<?php echo $_POST['last_name'] ?>"/>
