...
<div class="row">
	...
	<div class="grid_2"><img class="instructors"  src="./img/blackbelts/jdoster.png" alt=""></div>
	<div class="grid_2"><img class="instructors" src="./img/blackbelts/kerik.png" alt=""></div>
